...
const WeatherSnap = () => {
    const [temperature] = React.useState(N.rand(25, 40));
...
const Reminder = () => {
    return (React.createElement("div", { className: "reminder" },
        ...
        React.createElement("span", { className: "reminder-text" },
            ...
            React.createElement("span", { className: "reminder-time" }, "0AM"))));
};
const Time = () => {
...
const Weather = () => {
    ...
    return (React.createElement(MenuSection, { icon: "fa-solid fa-sun", id: "weather-section", scrollable: true, title: "How is the weather today?" }, getDays()));
};
const Tools = () => {
    const getTools = () => {
        return [{
    ...
    return (React.createElement("div", { id: "app-menu" },
        React.createElement("div", { id: "app-menu-content-wrapper" },
            React.createElement("div", { id: "app-menu-content" },
                ...
                React.createElement("a", { id: "youtube-link", className: "clear-button", href: "github.com/Nalini1998", target: "_blank" },
                    React.createElement("i", { className: "fa-brands fa-github" }),
                    React.createElement("span", null, "Meow.Nalini98")),
